    ...
    return (
        ...
        <div className={classN}>
            ...
            <ul  className="menu-navbars">
                       ...
                       <li onClick={scrollToTop} > <NavLink className='colored cartes' to='/2tales/cart'><img src={cart} alt="cart" className="cart" width="30px" /><p className="carted">{localStorage.getItem('userjwt') ? count : 0}</p></NavLink></li>
